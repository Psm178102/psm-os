...
from _auth_lib import supabase_client, require_user, AuthError, audit, frente_of, notify_all, can_route  # type: ignore

# v86.67: a alçada desta tela é decidida pela MATRIZ por papel (como no menu), não só por nível.
_GATE_ROUTES = ['/cs-avaliacoes', '/minha-producao']
_GATE_GROUP = 'sucesso'
