...
DEFAULT = {
    ...
    "secoes": [
        ...
        {"id": "dresscode", "ico": "👔", "titulo": "Apresentação Pessoal & Dress Code", "tipo": "lista", "conteudo": "", "itens": [
            "Sua imagem é a imagem da PSM: apresentação impecável em TODA interação profissional — e régua máxima em eventos externos, meetings e atendimentos.",
            "Higiene em dia: banho diário, desodorante, hálito e unhas cuidadas. Perfume com moderação — nem odor corporal, nem excesso de fragrância.",
            "Cabelo limpo e alinhado; barba feita ou aparada, com manutenção regular.",
            "Vestimenta: casual executivo — roupas limpas, passadas, bem-cuidadas e sem excessos.",
            "PROIBIDO na função: boné, touca e boina.",
            "PROIBIDO: chinelos, rasteirinhas e calçados masculinos abertos.",
            "PROIBIDO: shorts, camisetas estampadas e moletons/jaquetas com estampas.",
            "Acessórios: discretos e em quantidade moderada — excesso compromete a imagem.",
            "Neutralidade perante o cliente: sem itens simbólicos de religião, política ou time de futebol no exercício da função (a regra vale pro contexto profissional; suas convicções pessoais são respeitadas).",
            "Fora do padrão = fora do compromisso: parceiro inadequado não representa a PSM naquele atendimento, meeting ou evento (Código de Ética, Cap. 4, Arts. 14 a 15-B).",
        ]},
