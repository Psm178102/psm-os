...
DEFAULT = {
    ...
    "secoes": [
        ...
        {"id": "organograma", "ico": "🏛", "titulo": "Organograma e Funções", "tipo": "lista", "conteudo": "", "itens": [
            ...
            "Líder — gestão de metas e KPIs dos corretores, acompanhamento de atendimentos e fechamentos, treinamentos de produto e previsão semanal do time. Reporta ao Head de Operações.",
            ...
            "Vera 3.5 — I.A. exclusiva: onboarding, operação diária do corretor, dúvidas, métricas e KPIs, conhecimento dos empreendimentos. O braço direito do corretor.",
            "Comunidade PSM (Kiwify) — aulas gravadas, treinos e mentorias coletivas, conteúdos por módulos.",
        ]},
