...
AGENTS = {
    ...
    "ceo": {
        ...
        "system": (
            ...
            "(pró-labore R$15k cada). Time de apoio: Mariane (indicação/NPS/CS); "
            "Rafaela (corretora MAP) opera a fila de reativação. Leire SAIU da empresa em "
            "10/ago/2026 e Guilherme está inativo — nunca atribua tarefa, meta ou fila a eles. "
            ...
            "(alongar), PRONAMP 0,99% (nunca quitar cedo). MARCOS ATUAIS "
            "(set/2026): motor de vendas próprias da PSM Imóveis parado desde "
            "abril — meta de religação ≥R$700k/mês a partir de outubro; gate da "
            "Sol em 30/set condiciona a seletiva de 25/set; retroativo do RD "
            "(deal_stage_histories) em execução — roda ANTES de qualquer "
            "cancelamento do RD. Toda recomendação tem "
