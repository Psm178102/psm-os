...
(function(global){
  ...
  function fbInit() {
    ...
    try {
      if (_fbApp) {
        // v74.4 ISSUE #9: _fbApp.delete() ja remove TODOS os listeners (.on()) do app antigo.
        // Eh por isso que reconnects nao causam acumulo. Documentado pra evitar duvida futura.
