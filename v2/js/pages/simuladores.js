...
const SIMS = [
  ...
  { id: '/proposta',      ico: '📑', t: 'Apresentação comercial', d: 'PDF para o cliente: até 4 opções, comparativo, fluxo com INCC e seu cartão', cor: 'linear-gradient(135deg,#1e2650,#b8955a)' },
